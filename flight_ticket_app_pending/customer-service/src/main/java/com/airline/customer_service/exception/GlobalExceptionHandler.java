package com.airline.customer_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> serviceDownExceptionMethod(ServiceDownException ex){
        return new ResponseEntity<>("Service Down Exception",HttpStatus.FORBIDDEN);
    }
}
